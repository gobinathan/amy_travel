...
class SlimStatConfig {
	...
	/** Database connection */
	var $server = ""; // Leave as localhost unless you know otherwise
	...
	/** Database tables */
	var $stats = "stats"; // Primary stats table
	var $dt_table = "stats_dt"; // Date/time totals table
	var $countries = "stats_iptocountry"; // IP-to-country lookup table
	
	/** The full name of your site */
	var $sitename = "Statistics";
