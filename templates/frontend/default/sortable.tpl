	<br/><div id="controls" {if $smarty.foreach.count_items.iteration <= $conf.items_per_page}style="display:none;"{/if}>
		<div id="perpage">
			...
			<option value="5" {if $conf.items_per_page eq "5"}selected="selected"{/if}>5</option>
				<option value="10" {if $conf.items_per_page eq "10"}selected="selected"{/if}>10</option>
				<option value="20" {if $conf.items_per_page eq "20"}selected="selected"{/if}>20</option>
				<option value="50" {if $conf.items_per_page eq "50"}selected="selected"{/if}>50</option>
				<option value="100" {if $conf.items_per_page eq "100"}selected="selected"{/if}>100</option>
			</select>
