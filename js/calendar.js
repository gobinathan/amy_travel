...
Calendar.prototype.showAtElement = function (el, opts) {
	...
	Calendar.continuation_for_the_fucking_khtml_browser = function() {
		...
		//var valign = opts.substr(0, 1); - blocked by Ashok
		var AmountOfYScroll = document.documentElement.scrollTop; 
		var HeightOfScreen = document.documentElement.clientHeight; 
		var PositionOfElement = p.y; var HeightOfCalendar = (h+40);
		if (Calendar.is_ie7up && ( (PositionOfElement - AmountOfYScroll + HeightOfCalendar ) >= (HeightOfScreen) ) ) 
			 { 
				var valign = "T"; 
			 }
			 else
