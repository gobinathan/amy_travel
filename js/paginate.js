/*
        paginate table object v1.3 by frequency-decoder.com
        ...
        */
                        ...
                        for(var i = arr[e][0]; i < arr[e][1]; i++) {
                                if(e) {
                                        if(tablePaginater.tableInfo[tblId].rowStyle && tablePaginater.tableInfo[tblId].rowsPerPage % 2 != 0) {
                                                if(cnt++ % 2) tablePaginater.addClass(trs[i], tablePaginater.tableInfo[tblId].rowStyle);
        ...
        buttonClick: function(e) {
                ...
                if(a.className.search("previous-page") != -1) {
                        tablePaginater.tableInfo[tblId].currentPage = tablePaginater.tableInfo[tblId].currentPage > 1 ? tablePaginater.tableInfo[tblId].currentPage - 1 : max;
                        showPrevNext = 1;
